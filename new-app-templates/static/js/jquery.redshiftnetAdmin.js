/* 
  Author: The Phoeron
  Site: www.thephoeron.com
  Plugin: redshiftnetAdmin
  Version: 1.1.1
  REDSHIFTNET Admin core functionality
  http://redshiftnet.com/
*/

;(function($) {	
    // Using it without an object
    $.redshiftnetAdmin = function(options) { return $.fn.redshiftnetAdmin(options); };
    
    $.fn.redshiftnetAdmin = function(options) { 
