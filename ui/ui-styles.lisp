...
(define-easy-handler (rsn-ui-icons-css :uri "/css/icons.css") ()
  (setf (content-type*) "text/css")
  (cl-css:css
    '(("@font-face"
        :font-family "icomoonregular"
        :src "url(/static/css/fonts/icomoon.eot)"
        :src "url(/static/css/fonts/icomoon.eot?#iefix) format(embedded-opentype), url(/static/css/fonts/icomoon.woff) format(woff), url(/static/css/fonts/icomoon.ttf) format(truetype), url(/static/css/fonts/icomoon.svg#icomoonregular) format(svg)"
        :font-weight "normal"
        :font-style "normal")
